...
function ReturnContent() {
  ...
  if (!vendor) return <p className="text-gray-500">Loading your status…</p>;
  ...
  return (
    <div className="max-w-md mx-auto py-10">
      <div className="card text-center space-y-4">
        ...
        <Link href="/" className="text-sm text-gray-400 hover:text-brand block">
          ← Back to home
        </Link>
      </div>
    </div>
...
export default function ReturnPage() {
  return (
    <Suspense fallback={<p className="text-gray-500 text-center py-20">Loading…</p>}>
      <ReturnContent />
    </Suspense>
  );
}
